...
| Instead of      | Run                                                                                                                                                |
| --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `make demo-venkateshulu` | `python -m kartavya.cli.run tests/fixtures/venkateshulu_real_pdf_wp13296_2022/original.pdf --dry-run`                    |
| `make demo-positive`     | `python -m kartavya.cli.run tests/fixtures/synthetic_disposed_with_directions/judgment.pdf --dry-run --demo-positive` |
